...
type User struct {
	...
	StatusAccount   string    `json:"status_account" gorm:"type:enum('blocked', 'inactive', 'active');not null"`
	UrlPhotoProfile string    `json:"url_photo_profile" gorm:"type:varchar(255);not null"`
	CreatedAt       int64     `json:"created_at" gorm:"autoCreateTime:milli;not null"`
	UpdatedAt       int64     `json:"updated_at" gorm:"autoCreateTime:milli;autoUpdateTime:milli;not null"`
